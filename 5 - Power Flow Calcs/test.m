...
a.gen(:, 11) =  0.458*P_max; % Pc1
a.gen(:, 12) =  1.000*P_max; % Pc2
a.gen(:, 13) = -1.000*P_max; % Qc1min
a.gen(:, 14) =  1.000*P_max; % Qc1max
a.gen(:, 15) = -0.458*P_max; % Qc2min
a.gen(:, 16) =  0.458*P_max; % Qc2max
